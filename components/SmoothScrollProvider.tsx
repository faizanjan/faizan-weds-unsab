 ...
 * from Lenis' RAF loop, so scrubbed timelines stay in sync with the eased
 * scroll position. Scrolling is left natural — the wheel/touch move the page
 * as the reader expects, with a gentle momentum, and nothing is hijacked.
 */
